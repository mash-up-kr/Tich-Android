...
import kotlinx.android.synthetic.main.fragment_tooth_brush.*
...
class ToothBrushFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tooth_brush, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tooth_brush_back.setOnClickListener {
            removeFragment()
