...
fun TextView.setDrawablesWithIntrinsicBounds(
    ...
    if (left != 0) context.getDrawable(left) else compoundDrawables[0],
    if (top != 0) context.getDrawable(top) else compoundDrawables[1],
    if (right != 0) context.getDrawable(right) else compoundDrawables[2],
    if (bottom != 0) context.getDrawable(bottom) else compoundDrawables[3]
)
...
fun TextView.setDrawablesRelativeWithIntrinsicBounds(
    ...
    if (start != 0) context.getDrawable(start) else compoundDrawablesRelative[0],
    if (top != 0) context.getDrawable(top) else compoundDrawablesRelative[1],
    if (end != 0) context.getDrawable(end) else compoundDrawablesRelative[2],
    if (bottom != 0) context.getDrawable(bottom) else compoundDrawablesRelative[3]
)
